...
func Load() *Config {
	...
	c.ProductServiceHost = cast.ToString(getOrReturnDefault("POST_SERVICE_HOST", "productservice"))
	c.ProductServicePort = cast.ToInt(getOrReturnDefault("POST_SERVICE_HOST", "5050"))
